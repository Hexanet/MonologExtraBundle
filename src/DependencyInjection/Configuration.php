            ...
            ->children()
                ...
                ->arrayNode('processor')
                    ...
                    ->children()
                        ...
                        ->scalarNode('psr_log_message')
                            ->info("Processes a record's message according to PSR-3 rules")
                            ->defaultTrue()
                        ->end()
                        ...
                        ->scalarNode('environment')
                            ->info("Adds kernel environnement into records")
                            ->defaultFalse()
                        ->end()
                        ->scalarNode('uid')
                            ...
                            ->defaultFalse()
                        ->end()
                        ->scalarNode('process_id')
                            ->info("Adds value of getmypid into records")
                            ->defaultFalse()
                        ->end()
                        ->arrayNode('additions')
